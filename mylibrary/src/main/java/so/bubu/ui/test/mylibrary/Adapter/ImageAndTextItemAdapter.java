...
public  abstract class ImageAndTextItemAdapter extends ComRecyclerViewAdapter{
    ...
    public void convert(RecyclerViewHolder viewHolder, Object item, int position)
    {
        ...
        doOrther(viewHolder, mDatasList.get(position), position);
    }

    public abstract void doOrther(RecyclerViewHolder viewHolder, HashMap<String, Object> item, int position);
