package so.bubu.ui.test.mylibrary.input.picUploader.lubanCompress;
...
import static so.bubu.ui.test.mylibrary.input.picUploader.lubanCompress.Preconditions.checkNotNull;
