package so.bubu.ui.test.mylibrary.uploadimage.task;
...
import so.bubu.ui.test.mylibrary.uploadimage.callback.BitmapCropCallback;
import so.bubu.ui.test.mylibrary.uploadimage.model.CropParameters;
import so.bubu.ui.test.mylibrary.uploadimage.model.ExifInfo;
import so.bubu.ui.test.mylibrary.uploadimage.model.ImageState;
import so.bubu.ui.test.mylibrary.uploadimage.util.FileUtils;
import so.bubu.ui.test.mylibrary.uploadimage.util.ImageHeaderParser;
